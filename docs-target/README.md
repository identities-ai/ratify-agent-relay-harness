...
This directory mirrors the `/docs` tree of the public target repository (`identities-ai/ratify-agent-relay-engagement`) that the Phase 2 engagement runs against, so the harness can rehearse locally before that repo exists.
